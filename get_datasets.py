...
parser.add_argument('--datasets', nargs='+', help='name of dataset: choose from [nyu, voc, sbd, coco2014, coco2017]', required=True)
parser.add_argument('--data_directory', type=str, default='datasets', help='directory to save datasets to')
args = parser.parse_args()

# valid datasets
valid_datasets = ['nyu', 'voc', 'sbd', 'coco2014', 'coco2017']
